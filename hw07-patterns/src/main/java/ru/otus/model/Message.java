...
public class Message {
    ...
    public static Message copyOf(Message other) {
        return new Message.Builder(other.getId())
                .field1(other.getField1())
                .field2(other.getField2())
                .field3(other.getField3())
                .field4(other.getField4())
                .field5(other.getField5())
                .field6(other.getField6())
                .field7(other.getField7())
                .field8(other.getField8())
                .field9(other.getField9())
                .field10(other.getField10())
                .field11(other.getField11())
                .field12(other.getField12())
                .field13(other.getField13() == null ? null : new ObjectForMessage(other.getField13()))
                .build();
    }
